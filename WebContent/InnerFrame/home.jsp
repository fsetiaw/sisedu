...
<%
        ...
        <%  
	  	...
	  	if(sdmn.adaRequestPymntApproval(v_scope_id)) {
		%>
	...
	<%
		...
		if(sdmn.isTherePengajuanCuti(v_scope_id)) {	
			...
			%>
			<a href="go.moCuti?target_thsms=<%=Checker.getThsmsHeregistrasi() %>" target="inner_iframe" class="tile bg-orange fg-white" data-role="tile">
				<div class="tile-content">
...
<%
		...
		//=====================prodi yg belum mengajukan kelas===========================
				v_scope_id = validUsr.returnScopeProdiOnlySortByKampusWithListIdobj("reqBukaKelas"); 	
				//if(sdmn.getNotificationPengajuanCuti()) {
					
				if(sdmn.isThereProdiYgBelumMengajukanKelasPerkuliahan(v_scope_id)) {	
				
					%>
					<a href="prep.infoListProdiNoClass" target="inner_iframe" class="tile bg-orange fg-white" data-role="tile">
						<div class="tile-content">
	...
	<div class="tile-group quadro">
        ...
        <div class="tile-container">
            ...
            <a class="tile bg-darkOrange fg-white" data-role="tile" href="get.sebaranTrlsm" target="inner_iframe">    
				...
				<div style="margin:80px 0 0 40px;position: absolute;">   
